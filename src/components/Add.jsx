...
import { addProjectResponeContext } from '../contexts/ContextApi'

const Add = () => {
  const {addProjectResponse,setAddProjectResponse} = useContext(addProjectResponeContext)
          ...
          <div className="row align-items-center">
            <div className="col-lg-4">
              <label>
                ...
                <img className='img-fluid' height={'200px'} src={preview?preview:uploadImage} alt="" />
              </label>
